...
<head>
  ...
  <title>View Prescription Status</title>
...
<div class="supercontainer">
  ...
  <div class="container">
  <form action="patientprescriptionview.php"  method="post" >
 
  <input type="number" name="patientid" placeholder="Enter patient ID" class="search" required>
    <a href="patientprescriptionview.php"><input type="submit"  name="dbsearch"  value="Search" ></a>
